...
- ☁️ Backend support — store logs locally (SQLite) which you can append to your backend database. *I use Airtable which I've added helper functions that enables you to write and read to the database but this step is optional*

## Repository Structure
This repo contains the Python package (colab_error_logger), a sample notebook, and scripts for logging errors and syncing them with Airtable or SQLite.
